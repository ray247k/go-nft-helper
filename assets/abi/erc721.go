...
func (_Erc721 *Erc721Caller) ERC712VERSION(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "ERC712_VERSION")
...
//
// Solidity: function ERC712_VERSION() view returns(string)
func (_Erc721 *Erc721Session) ERC712VERSION() (string, error) {
	return _Erc721.Contract.ERC712VERSION(&_Erc721.CallOpts)
}

// ERC712VERSION is a free data retrieval call binding the contract method 0x0f7e5970.
//
// Solidity: function ERC712_VERSION() view returns(string)
func (_Erc721 *Erc721CallerSession) ERC712VERSION() (string, error) {
	return _Erc721.Contract.ERC712VERSION(&_Erc721.CallOpts)
}
...
//
// Solidity: function baseTokenURI() pure returns(string)
...
func (_Erc721 *Erc721Caller) GetDomainSeperator(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "getDomainSeperator")
...
//
// Solidity: function getDomainSeperator() view returns(bytes32)
func (_Erc721 *Erc721Session) GetDomainSeperator() ([32]byte, error) {
	return _Erc721.Contract.GetDomainSeperator(&_Erc721.CallOpts)
}

// GetDomainSeperator is a free data retrieval call binding the contract method 0x20379ee5.
//
// Solidity: function getDomainSeperator() view returns(bytes32)
func (_Erc721 *Erc721CallerSession) GetDomainSeperator() ([32]byte, error) {
	return _Erc721.Contract.GetDomainSeperator(&_Erc721.CallOpts)
}
...
func (_Erc721 *Erc721Caller) GetNonce(opts *bind.CallOpts, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "getNonce", user)
...
//
// Solidity: function getNonce(address user) view returns(uint256 nonce)
func (_Erc721 *Erc721Session) GetNonce(user common.Address) (*big.Int, error) {
	return _Erc721.Contract.GetNonce(&_Erc721.CallOpts, user)
}

// GetNonce is a free data retrieval call binding the contract method 0x2d0335ab.
//
// Solidity: function getNonce(address user) view returns(uint256 nonce)
func (_Erc721 *Erc721CallerSession) GetNonce(user common.Address) (*big.Int, error) {
	return _Erc721.Contract.GetNonce(&_Erc721.CallOpts, user)
}
...
//
// Solidity: function tokenURI(uint256 _tokenId) pure returns(string)
...
func (_Erc721 *Erc721Transactor) ExecuteMetaTransaction(opts *bind.TransactOpts, userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "executeMetaTransaction", userAddress, functionSignature, sigR, sigS, sigV)
}

// ExecuteMetaTransaction is a paid mutator transaction binding the contract method 0x0c53c51c.
//
// Solidity: function executeMetaTransaction(address userAddress, bytes functionSignature, bytes32 sigR, bytes32 sigS, uint8 sigV) payable returns(bytes)
func (_Erc721 *Erc721Session) ExecuteMetaTransaction(userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Erc721.Contract.ExecuteMetaTransaction(&_Erc721.TransactOpts, userAddress, functionSignature, sigR, sigS, sigV)
}

// ExecuteMetaTransaction is a paid mutator transaction binding the contract method 0x0c53c51c.
//
// Solidity: function executeMetaTransaction(address userAddress, bytes functionSignature, bytes32 sigR, bytes32 sigS, uint8 sigV) payable returns(bytes)
func (_Erc721 *Erc721TransactorSession) ExecuteMetaTransaction(userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Erc721.Contract.ExecuteMetaTransaction(&_Erc721.TransactOpts, userAddress, functionSignature, sigR, sigS, sigV)
}

// MintTo is a paid mutator transaction binding the contract method 0x755edd17.
//
// Solidity: function mintTo(address _to) returns()
func (_Erc721 *Erc721Transactor) MintTo(opts *bind.TransactOpts, _to common.Address) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "mintTo", _to)
}

// MintTo is a paid mutator transaction binding the contract method 0x755edd17.
//
// Solidity: function mintTo(address _to) returns()
func (_Erc721 *Erc721Session) MintTo(_to common.Address) (*types.Transaction, error) {
	return _Erc721.Contract.MintTo(&_Erc721.TransactOpts, _to)
}

// MintTo is a paid mutator transaction binding the contract method 0x755edd17.
//
// Solidity: function mintTo(address _to) returns()
func (_Erc721 *Erc721TransactorSession) MintTo(_to common.Address) (*types.Transaction, error) {
	return _Erc721.Contract.MintTo(&_Erc721.TransactOpts, _to)
}
...
// Erc721MetaTransactionExecutedIterator is returned from FilterMetaTransactionExecuted and is used to iterate over the raw logs and unpacked data for MetaTransactionExecuted events raised by the Erc721 contract.
type Erc721MetaTransactionExecutedIterator struct {
	Event *Erc721MetaTransactionExecuted // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Erc721MetaTransactionExecutedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Erc721MetaTransactionExecuted)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Erc721MetaTransactionExecutedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Erc721MetaTransactionExecutedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Erc721MetaTransactionExecuted represents a MetaTransactionExecuted event raised by the Erc721 contract.
type Erc721MetaTransactionExecuted struct {
...
func (_Erc721 *Erc721Filterer) FilterMetaTransactionExecuted(opts *bind.FilterOpts) (*Erc721MetaTransactionExecutedIterator, error) {

	logs, sub, err := _Erc721.contract.FilterLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
	return &Erc721MetaTransactionExecutedIterator{contract: _Erc721.contract, event: "MetaTransactionExecuted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event MetaTransactionExecuted(address userAddress, address relayerAddress, bytes functionSignature)
func (_Erc721 *Erc721Filterer) WatchMetaTransactionExecuted(opts *bind.WatchOpts, sink chan<- *Erc721MetaTransactionExecuted) (event.Subscription, error) {

	logs, sub, err := _Erc721.contract.WatchLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc721MetaTransactionExecuted)
				if err := _Erc721.contract.UnpackLog(event, "MetaTransactionExecuted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MetaTransactionExecuted(address userAddress, address relayerAddress, bytes functionSignature)
func (_Erc721 *Erc721Filterer) ParseMetaTransactionExecuted(log types.Log) (*Erc721MetaTransactionExecuted, error) {
	event := new(Erc721MetaTransactionExecuted)
	if err := _Erc721.contract.UnpackLog(event, "MetaTransactionExecuted", log); err != nil {
		return nil, err
	}
